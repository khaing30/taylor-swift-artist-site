...
setText("[data-previous-side-title]", previousAlbum.label);
setText("[data-next-side-title]", nextAlbum.label);
...
$("[data-previous-side-link]").href = `album.html?album=${previousKey}`;
$("[data-next-side-link]").href = `album.html?album=${nextKey}`;
$("[data-previous-side-link]").setAttribute("aria-label", `Previous album: ${previousAlbum.title}`);
$("[data-next-side-link]").setAttribute("aria-label", `Next album: ${nextAlbum.title}`);
